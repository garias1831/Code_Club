...
def start_game():
    ...
    prompt = input("I love numbers. Type 'n' to exit. Press any other key to run it back. ")

    #Making sure the prompt variable is lowecase, in case they had caps lock on or something 
    if prompt.lower() != "n":
        start_game()
